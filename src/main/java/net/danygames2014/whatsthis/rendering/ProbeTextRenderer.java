...
public class ProbeTextRenderer extends TextRenderer {
    ...
    public static final ProbeTextRenderer INSTANCE = new ProbeTextRenderer(Minecraft.INSTANCE.options, "/font/default.png", Minecraft.INSTANCE.textureManager);

    public ProbeTextRenderer(GameOptions gameOptions, String texturePath, TextureManager textureManager) {
